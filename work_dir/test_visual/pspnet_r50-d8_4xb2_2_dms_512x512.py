...
launcher = 'none'
load_from = 'work_dir\\test_visual\\last_checkpoint'
log_level = 'INFO'
...
train_cfg = dict(max_iters=2, type='IterBasedTrainLoop', val_interval=2)
...
val_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='images/validation', seg_map_path='labels/validation'),
        data_root='data/DMS',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(keep_ratio=True, scale=(
...
visualizer = dict(
    name='visualizer',
    save_dir='work_dir/test_visual',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
        dict(type='TensorboardVisBackend'),
    ])
work_dir = 'work_dir/test_visual'
